...
//	EgovMessageSource egovMessageSource;
	 ...
	 * @exception Exception
	 */
	@IncludedInfo(name = "메뉴생성관리", order = 20, gid = 60)
...
//		}
		...
		*/
		...
		return "menu/EgovMenuCreatManage";
	}
...
//		}
	 ...
	 *            String
	 * @return 출력페이지정보 등록처리시 "redirect:/sym/mnu/mcm/EgovMenuCreatSelect.do"
	 * @exception Exception
	 */
...
//		}
	...
	public String selectMenuCreatSiteMap(@ModelAttribute("menuSiteMapVO") MenuSiteMapVO menuSiteMapVO, ModelMap model) throws Exception {
		...
		return "menu/EgovMenuCreatSiteMap";
	}
