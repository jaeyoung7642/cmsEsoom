...
public class MenuManageVO{
	   ...
	   private   List<MenuManageVO> menuchild;
	   /** 사이트맵 */
	   /** 생성자ID **/
	   ...
	   private   String   tmpCmd;
		...
		public List<MenuManageVO> getMenuchild() {
			return menuchild;
		}
		public void setMenuchild(List<MenuManageVO> menuchild) {
			this.menuchild = menuchild;
		}
		public void setMenuChild(MenuManageVO childMenu) {
	        if (menuchild == null) {
	        	menuchild = new ArrayList<>();
	        }
	        menuchild.add(childMenu);  // 자식 메뉴 추가
	    }
		/**
		...
		public String toString() {
			return "MenuManageVO [menuNo=" + menuNo + ", menuOrdr=" + menuOrdr + ", menuNm=" + menuNm + ", upperMenuId="
					+ upperMenuId + ", menuDc=" + menuDc + ", relateImagePath=" + relateImagePath + ", relateImageNm="
					+ relateImageNm + ", progrmFileNm=" + progrmFileNm + ", menuUrl=" + menuUrl + ", creatPersonId="
					+ creatPersonId + ", authorCode=" + authorCode + ", tempValue=" + tempValue + ", tempInt=" + tempInt
					+ ", tmpId=" + tmpId + ", tmpPassword=" + tmpPassword + ", tmpName=" + tmpName + ", tmpUserSe="
					+ tmpUserSe + ", tmpEmail=" + tmpEmail + ", tmpOrgnztId=" + tmpOrgnztId + ", tmpUniqId=" + tmpUniqId
					+ ", tmpCmd=" + tmpCmd + "]";
		}
