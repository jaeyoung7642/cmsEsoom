...
public class EgovPrivacyLogController {
	 ...
	 * @throws Exception
	 */
	@IncludedInfo(name="개인정보조회로그관리", listUrl="/sym/log/plg/SelectPrivacyLogList.do", order = 430 ,gid = 110)
	...
	public String selectWebLog(@ModelAttribute("searchVO") PrivacyLog privacyLog,
		...
		return "sys/EgovPrivacyLogDetail";
	}
