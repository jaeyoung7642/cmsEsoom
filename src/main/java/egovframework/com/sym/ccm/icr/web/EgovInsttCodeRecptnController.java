...
public class EgovInsttCodeRecptnController {
	 ...
	 * @param commandMap
	 * @param model
	 * @return "sys/EgovInsttCodeRegist_TEST"
	 * @return "redirect:/sym/ccm/icr/getInsttCodeRecptnList.do"
	 * @throws Exception
	 */
	...
	@RequestMapping(value="/sym/ccm/icr/getInsttCodeDetail.do")
 	public String selectInsttCodeDetail (@ModelAttribute("insttCode") InsttCodeRecptn insttCode
		...
		return "sys/EgovInsttCodeDetail";
	}
     ...
     * @param searchVO
     * @param model
     * @return "sys/EgovInsttCodeRecptnList"
     * @throws Exception
     */
	@IncludedInfo(name="기관코드수신", listUrl="/sym/ccm/icr/getInsttCodeRecptnList.do", order = 480 ,gid = 110)
	...
	public String selectInsttCodeRecptnMainList (@ModelAttribute("searchVO") InsttCodeRecptnVO searchVO
        ...
        return "sys/EgovInsttCodeRecptnMainList";
	}
