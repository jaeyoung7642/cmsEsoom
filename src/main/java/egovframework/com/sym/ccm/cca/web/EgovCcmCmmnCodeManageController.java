...
public class EgovCcmCmmnCodeManageController {
	 ...
	 * @param searchVO
	 * @param model
	 * @return "sys/EgovCcmCmmnCodeList"
	 * @throws Exception
	 */
	@IncludedInfo(name = "공통코드", listUrl = "/sym/ccm/cca/SelectCcmCmmnCodeList.do", order = 450, gid = 110)
	 ...
	 * @param cmmnCodeVO
	 * @param model
	 * @return "sys/EgovCcmCmmnCodeDetail"
	 * @throws Exception
	 */
	...
	public String insertCmmnCodeView(@ModelAttribute("cmmnCodeVO")CmmnCodeVO cmmnCodeVO, ModelMap model) throws Exception {
		...
		return "sys/EgovCcmCmmnCodeRegist";
	}
    ...
    public String insertCmmnCode(@ModelAttribute("searchVO") CmmnCodeVO cmmnCode, @ModelAttribute("cmmnCodeVO") CmmnCodeVO cmmnCodeVO,
		...
		return "redirect:/sym/ccm/cca/SelectCcmCmmnCodeList.do";
    }
     ...
     * @param cmmnCodeVO
     * @param model
     * @return "sys/EgovCcmCmmnCodeUpdt"
     * @throws Exception
     */
