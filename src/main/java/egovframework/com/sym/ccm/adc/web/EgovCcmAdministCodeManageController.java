...
public class EgovCcmAdministCodeManageController {
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "sys/EgovCcmAdministCodeRegist"
	 * @throws Exception
	 */
	 ...
	 * @param administCode
	 * @param model
	 * @return "sys/EgovCcmAdministCodeDetail"
	 * @throws Exception
	 */
     ...
     * @param searchVO
     * @param model
     * @return "sys/EgovCcmAdministCodeList"
     * @throws Exception
     */
	@IncludedInfo(name="행정코드관리", order = 470  ,gid = 110)
	 ...
	 * 일반달력 팝업 메인창을 호출한다.
	 * @param model
	 * @return "sys/EgovCcmAdministCodePopup"
	 * @throws Exception
	 */
     ...
     * @param searchVO
     * @param model
     * @return "sys/EgovCcmAdministCode"
     * @throws Exception
     */
	 ...
	 * @param commandMap
	 * @param model
	 * @return "sys/EgovCcmAdministCodeModify"
	 * @throws Exception
	 */
