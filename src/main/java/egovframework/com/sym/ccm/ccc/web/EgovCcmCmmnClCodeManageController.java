...
public class EgovCcmCmmnClCodeManageController {
	 ...
	 * @param searchVO
	 * @param model
	 * @return "sys/SelectCcmCmmnClCodeList"
	 * @throws Exception
	 */
	@IncludedInfo(name = "공통분류코드", listUrl = "/sym/ccm/ccc/SelectCcmCmmnClCodeList.do", order = 440, gid = 110)
	...
	public String selectCmmnClCodeList(@ModelAttribute("searchVO") CmmnClCodeVO searchVO, ModelMap model) throws Exception {
		...
		List<CmmnClCodeVO> CmmnCodeList = (List<CmmnClCodeVO>) cmmnClCodeManageService.selectCmmnClCodeList(searchVO);
		model.addAttribute("resultList", CmmnCodeList);
		for(CmmnClCodeVO v : CmmnCodeList) {
			System.out.println(v.getClCode());
		}
		...
		return "sys/EgovCcmCmmnClCodeList";
	}
	 ...
	 * @param cmmnClCode
	 * @param model
	 * @return "sys/SelectCcmCmmnClCodeDetail.do"
	 * @throws Exception
	 */
	...
	public String selectCmmnClCodeDetail(@ModelAttribute("loginVO") LoginVO loginVO, CmmnClCodeVO cmmnClCodeVO,
		...
		return "sys/EgovCcmCmmnClCodeDetail";
	}
	 ...
	 * @param cmmnClCodeVO
	 * @param model
	 * @return "sys/EgovCcmCmmnClCodeRegist";
	 * @throws Exception
	 */
    ...
    public String insertCmmnClCode(@ModelAttribute("cmmnClCodeVO") CmmnClCodeVO cmmnClCodeVO,
		...
		return "redirect:/sym/ccm/ccc/SelectCcmCmmnClCodeList.do";
    }
     ...
     * @param cmmnClCodeVO
     * @param model
     * @return "sys/EgovCcmCmmnClCodeUpdt";  
     * @throws Exception
     */
