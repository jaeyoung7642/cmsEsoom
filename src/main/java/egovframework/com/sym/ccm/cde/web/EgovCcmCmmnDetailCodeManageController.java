   ...
   private EgovCcmCmmnCodeManageService cmmnCodeManageService;
	...
	private DefaultBeanValidator beanValidator;
	   ...
	   /**
	     ...
	     * @param searchVO
	     * @param model
	     * @return "sys/EgovCcmCmmnDetailCodeList"
	     * @throws Exception
	     */
		@IncludedInfo(name="공통상세코드", listUrl="/sym/ccm/cde/SelectCcmCmmnDetailCodeList.do", order = 460 ,gid = 110)
		 ...
		 * @param model
		 * @return "sys/EgovCcmCmmnDetailCodeDetail"
		 * @throws Exception
		 */
		 ...
		 * @param cmmnDetailCodeVO
		 * @param model
		 * @return "redirect:/sym/ccm/cde/EgovCcmCmmnDetailCodeList.do"
		 * @throws Exception
		 */
		...
		public String insertCmmnDetailCodeView(@ModelAttribute("loginVO") LoginVO loginVO, @ModelAttribute("cmmnCodeVO") CmmnCodeVO cmmnCodeVO,
			...
			return "sys/EgovCcmCmmnDetailCodeRegist";
		}
...
//			    return "sys/EgovCcmCmmnDetailCodeRegist";
//			}
	    	System.out.println("toString>>>>>>>>>>>>>>>>>>>>>"+cmmnDetailCodeVO.getClCode());
	    	System.out.println("toString>>>>>>>>>>>>>>>>>>>>>"+cmmnDetailCodeVO.getCode());
	    	System.out.println("toString>>>>>>>>>>>>>>>>>>>>>"+cmmnDetailCodeVO.getCodeId());
	    	System.out.println("toString>>>>>>>>>>>>>>>>>>>>>"+cmmnDetailCodeVO.getCodeNm());
	    	System.out.println("toString>>>>>>>>>>>>>>>>>>>>>"+cmmnDetailCodeVO.getCodeIdNm());
	    	System.out.println("toString>>>>>>>>>>>>>>>>>>>>>"+cmmnDetailCodeVO.getCodeDc());
			if(cmmnDetailCodeVO.getCodeId() != null){
				System.out.println("cmmnDetailCodeVO.getCodeId()=========="+cmmnDetailCodeVO.getCodeId());
				CmmnDetailCode vo = cmmnDetailCodeManageService.selectCmmnDetailCodeDetail(cmmnDetailCodeVO);
				if(vo != null){
	     ...
	     * @param cmmnDetailCodeVO
	     * @param model
	     * @return "sys/EgovCcmCmmnDetailCodeUpdt"
	     * @throws Exception
	     */
	     ...
	     * @param cmmnDetailCodeVO
	     * @param model
	     * @return "sys/EgovCcmCmmnDetailCodeUpdt", "/sym/ccm/cde/SelectCcmCmmnDetailCodeList.do"
	     * @throws Exception
	     */
