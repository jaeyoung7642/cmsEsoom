...
public class EgovQustnrRespondInfoController {
	 ...
	 * @param commandMap
	 * @param model
	 * @return "service/EgovQustnrRespondInfoManageStatistics"
	 * @throws Exception
	 */
    ...
    throws Exception {
		...
		String sLocationUrl = "service/EgovQustnrRespondInfoManageStatistics";
	 ...
	 * @param commandMap
	 * @param model
	 * @return "service/EgovQustnrRespondInfoManageList"
	 * @throws Exception
	 */
	@IncludedInfo(name="설문조사", order = 180 ,gid = 50)
	 ...
	 * @param commandMap
	 * @param model
	 * @return "service/EgovQustnrRespondInfoManageRegist"
	 * @throws Exception
	 */
...
//    	}
		...
		String sLocationUrl = "service/EgovQustnrRespondInfoManageRegist";
	 ...
	 * @param model
	 * @return "service/EgovQustnrRespondInfoList"
	 * @throws Exception
	 */
...
//    	}
    ...
    throws Exception {
		...
		String sLocationUrl = "service/EgovQustnrRespondInfoDetail";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "service/EgovQustnrRespondInfoModify"
	 * @throws Exception
	 */
...
//    	}
		...
		String sLocationUrl = "service/EgovQustnrRespondInfoModify";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "service/EgovQustnrRespondInfoRegist"
	 * @throws Exception
	 */
...
//    	}
		...
		String sLocationUrl = "service/EgovQustnrRespondInfoRegist";
