...
public class EgovQustnrQestnManageController {
     ...
     * @param commandMap
     * @param model
     * @return "service/EgovQustnrQestnManageStatistics"
     * @throws Exception
     */
    ...
    throws Exception {
		...
		String sLocationUrl = "service/EgovQustnrQestnManageStatistics";
	 ...
	 * @param commandMap
	 * @param model
	 * @return "service/EgovQustnrQestnManageListPopup"
	 * @throws Exception
	 */
	 ...
	 * @param commandMap
	 * @param model
	 * @return "service/EgovQustnrQestnManageList"
	 * @throws Exception
	 */
	@SuppressWarnings("unused")
	@IncludedInfo(name="질문관리", order = 210 ,gid = 50)
...
//		LoginVO loginVO = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
	 ...
	 * @param commandMap
	 * @param model
	 * @return "service/EgovQustnrQestnManageDetail"
	 * @throws Exception
	 */
    ...
    throws Exception {
		...
		String sLocationUrl = "service/EgovQustnrQestnManageDetail";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "service/EgovQustnrQestnManageModify"
	 * @throws Exception
	 */
...
//    	}
		...
		String sLocationUrl = "service/EgovQustnrQestnManageModify";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "service/EgovQustnrQestnManageRegist"
	 * @throws Exception
	 */
...
//    	}
		...
		String sLocationUrl = "service/EgovQustnrQestnManageRegist";
