...
public class EgovQustnrTmplatManageController {
    ...
    public String egovQustnrTmplatManageMain(ModelMap model) throws Exception {
    	return "service/EgovQustnrTmplatManageMain";
    }
    ...
    public String egovQustnrTmplatManageLeft(ModelMap model) throws Exception {
    	return "service/EgovQustnrTmplatManageLeft";
    }
	 ...
	 * @param model
	 * @return "service/EgovQustnrTmplatManageList"
	 * @throws Exception
	 */
    @IncludedInfo(name="설문템플릿관리", order = 190 ,gid = 50)
	 ...
	 * @param qustnrTmplatManageVO
	 * @param commandMap
	 * @return "service/EgovQustnrTmplatManageImg"
	 * @throws Exception
	 */
	 ...
	 * @param commandMap
	 * @param model
	 * @return "service/EgovQustnrTmplatManageDetail"
	 * @throws Exception
	 */
    ...
    throws Exception {
		...
		String sLocationUrl = "service/EgovQustnrTmplatManageDetail";
	 ...
	 * @param qustnrTmplatManageVO
	 * @param model
	 * @return "service/EgovQustnrTmplatManageModify"
	 * @throws Exception
	 */
	@SuppressWarnings("unused")
	...
	public String qustnrTmplatManageModify(
    		...
    		ModelMap model)
    throws Exception {
		String sLocationUrl = "service/EgovQustnrTmplatManageModify";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "service/EgovQustnrTmplatManageModifyActor"
	 * @throws Exception
	 */
...
//    	}
	 ...
	 * @param qustnrTmplatManageVO
	 * @param model
	 * @return "service/EgovQustnrTmplatManageRegist"
	 * @throws Exception
	 */
...
//    	}
		...
		String sLocationUrl = "service/EgovQustnrTmplatManageRegist";
	 ...
	 * @param qustnrTmplatManageVO
	 * @param model
	 * @return "service/EgovQustnrTmplatManageRegistActor"
	 * @throws Exception
	 */
