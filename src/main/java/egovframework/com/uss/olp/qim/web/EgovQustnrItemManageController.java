...
public class EgovQustnrItemManageController {
	 ...
	 * @param model
	 * @return "service/EgovQustnrItemManageListPopup"
	 * @throws Exception
	 */
	 ...
	 * @param qustnrItemManageVO
	 * @param model
	 * @return "service/EgovQustnrItemManageList"
	 * @throws Exception
	 */
	@IncludedInfo(name="항목관리", order = 220 ,gid = 50)
    ...
    throws Exception {
		...
		String sLocationUrl = "service/EgovQustnrItemManageDetail";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "service/EgovQustnrItemManageModify"
	 * @throws Exception
	 */
...
//    	}
		...
		String sLocationUrl = "service/EgovQustnrItemManageModify";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "service/EgovQustnrItemManageRegist"
	 * @throws Exception
	 */
...
//    	}
		...
		String sLocationUrl = "service/EgovQustnrItemManageRegist";
