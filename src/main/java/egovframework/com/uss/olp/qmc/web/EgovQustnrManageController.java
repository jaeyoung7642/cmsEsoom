...
public class EgovQustnrManageController {
	 ...
	 * @param model
	 * @return "service/EgovQustnrManageListPopup"
	 * @throws Exception
	 */
	 ...
	 * @throws Exception
	 */
	@IncludedInfo(name="설문관리", order = 170 ,gid = 50)
    ...
    throws Exception {
		...
		return "service/EgovQustnrManageList";
	}
	 ...
	 * @param commandMap
	 * @param model
	 * @return "service/EgovQustnrManageDetail";
	 * @throws Exception
	 */
    ...
    throws Exception {
		...
		String sLocationUrl = "service/EgovQustnrManageDetail";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "service/EgovQustnrManageModify"
	 * @throws Exception
	 */
...
//    	}
		...
		String sLocationUrl = "service/EgovQustnrManageModify";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "service/EgovQustnrManageRegist"
	 * @throws Exception
	 */
...
//    	}
		...
		String sLocationUrl = "service/EgovQustnrManageRegist";
