...
public class EgovQustnrRespondManageController {
	 ...
	 * @param model
	 * @return "service/EgovQustnrRespondManageList"
	 * @throws Exception
	 */
	@IncludedInfo(name="응답자관리",  order = 200 ,gid = 50)
	 ...
	 * @param commandMap
	 * @param model
	 * @return "service/EgovQustnrRespondManageDetail"
	 * @throws Exception
	 */
    ...
    throws Exception {
		...
		String sLocationUrl = "service/EgovQustnrRespondManageDetail";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "service/EgovQustnrRespondManageModify"
	 * @throws Exception
	 */
...
//    	}
		...
		String sLocationUrl = "service/EgovQustnrRespondManageModify";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "service/EgovQustnrRespondManageRegist"
	 * @throws Exception
	 */
...
//    	}
		...
		String sLocationUrl = "service/EgovQustnrRespondManageRegist";
