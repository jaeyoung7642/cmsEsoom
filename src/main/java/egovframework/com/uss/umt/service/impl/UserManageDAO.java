...
public class UserManageDAO extends EgovComAbstractDAO{
     ...
     * @return List 업무사용자 목록정보
     */
    public List<?> selectAdminList(UserDefaultVO userSearchVO){
    	return list("userManageDAO.selectAdminList_S", userSearchVO);
    }
     ...
     */
    public int selectAdminListTotCnt(UserDefaultVO userSearchVO) {
        return (Integer)selectOne("userManageDAO.selectAdminListTotCnt_S", userSearchVO);
    }
    /**
     * 사용자총 갯수를 조회한다.
     * @param userSearchVO 검색조건
