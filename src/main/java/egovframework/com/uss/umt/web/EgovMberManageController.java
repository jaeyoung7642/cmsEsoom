...
public class EgovMberManageController {
	 ...
	 * @throws Exception
	 */
	@IncludedInfo(name = "일반회원관리", order = 240, gid = 120)
...
//		}
		...
		List<GroupManageVO> groupList = egovGroupManageService.useGroupList(groupVo);
	...
	public String updateMberView(@RequestParam("selectedId") String mberId, @ModelAttribute("searchVO") UserDefaultVO userSearchVO, Model model) throws Exception {
		...
		return "member/EgovMberSelectUpdt";
	}
	...
	public String updateLockIncorrect(MberManageVO mberManageVO, Model model,RedirectAttributes redirectAttributes) throws Exception {
	    ...
	    redirectAttributes.addAttribute("selectedId", mberManageVO.getUniqId());
	    
	    return "redirect:/uss/umt/EgovMberSelectUpdtView.do";
	}
	...
	public String sbscrbEntrprsMber(Model model) throws Exception {
		...
		return "member/EgovStplatCnfirm";
	}
	...
	public String updatePassword(ModelMap model, @RequestParam Map<String, Object> commandMap, @ModelAttribute("searchVO") UserDefaultVO userSearchVO,
		...
		return "member/EgovMberPasswordUpdt";
	}
