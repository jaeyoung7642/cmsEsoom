...
public class EgovPopupManageController {
	 ...
	 * @param popupManageVO
	 * @param model
	 * @return "service/listPopupManage"
	 * @throws Exception
	 */
	@IncludedInfo(name = "팝업창관리", order = 150, gid = 50)
	...
	public String egovPopupManageDetail(PopupManageVO popupManageVO, @RequestParam Map<?, ?> commandMap, ModelMap model) throws Exception {
		...
		String sLocationUrl = "service/EgovPopupDetail";

		String sCmd = commandMap.get("cmd") == null ? "" : (String) commandMap.get("cmd");

		if (sCmd.equals("del")) {
			egovPopupManageService.deletePopup(popupManageVO);
			sLocationUrl = "redirect:/uss/ion/pwm/listPopup.do";
		} else {
			//상세정보 불러오기
...
//		}
		...
		String sLocationUrl = "service/EgovPopupUpdt";
...
//		}
		...
		String sLocationUrl = "service/EgovPopupRegist";
	...
	public String egovPopupManageMainList(PopupManageVO popupManageVO, ModelMap model) throws Exception {
		...
		return "service/EgovPopupMainList";
	}
