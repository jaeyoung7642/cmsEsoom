...
public class BBSAddedOptionsDAO extends EgovComAbstractDAO {
     ...
     * @param BoardMasterVO
     */
    public BoardMasterVO selectAddedOptionsInf(BoardMasterVO boardMasterVO) throws Exception {
	return (BoardMasterVO)selectOne("BBSAddedOptions.selectAddedOptionsInf", boardMasterVO);
    }
