...
public class EgovArticleServiceImpl extends EgovAbstractServiceImpl implements EgovArticleService {
    ...
    @Override
    public List<BoardVO> articleListHome(BoardVO boardVO) {
    	return egovArticleDao.articleListHome(boardVO);
    }
	@Override
	...
	@Override
	public void insertArticle(BoardVO board) throws FdlException {
