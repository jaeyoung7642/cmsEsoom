...
public class BoardMaster implements Serializable {
     ...
     * @return
     */
    public String getThumPosblAt() {
		return thumPosblAt;
	}
	public void setThumPosblAt(String thumPosblAt) {
		this.thumPosblAt = thumPosblAt;
	}
	...
	public String getMaskAt() {
		return maskAt;
	}
	public void setMaskAt(String maskAt) {
		this.maskAt = maskAt;
	}
	...
	public String getYtubeAt() {
		return ytubeAt;
	}
	public void setYtubeAt(String ytubeAt) {
		this.ytubeAt = ytubeAt;
	}
