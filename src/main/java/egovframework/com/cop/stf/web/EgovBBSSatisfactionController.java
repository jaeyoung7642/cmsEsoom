...
public class EgovBBSSatisfactionController {
    ...
    public String selectSatisfactionList(@ModelAttribute("searchVO") SatisfactionVO satisfactionVO, ModelMap model) throws Exception {
		...
		if (satisfactionVO.getType().equals("head")) {
		    return "board/EgovSatisfactionList";
		}
		////----------------------------------------
    ...
    public String insertSatisfaction(@ModelAttribute("searchVO") SatisfactionVO satisfactionVO, @ModelAttribute("satisfaction") Satisfaction satisfaction, 
	    BindingResult bindingResult, ModelMap model, RedirectAttributes redirect) throws Exception {
		...
		String progrmNm = satisfaction.getProgrmNm();
		String bbsId = satisfaction.getBbsId();
		Long nttId = satisfaction.getNttId();
	
		if (progrmNm.equals("board")) {
			if (nttId > 0) {
				redirect.addAttribute("bbsId",bbsId);
				redirect.addAttribute("nttId",nttId);
				return "redirect:/cop/bbs/selectArticleDetail.do";
			} else {
				redirect.addAttribute("bbsId",bbsId);
				return "redirect:/cop/bbs/selectArticleList.do";
			}
		} else if (progrmNm.equals("faqList")) {
			return "redirect:/uss/olh/faq/selectFaqList.do";
		} else {
			return progrmNm;
			//return "redirect:/cop/bbs/temp.do";
		}
    ...
    public String insertAnonymousSatisfaction(@ModelAttribute("searchVO") SatisfactionVO satisfactionVO, @ModelAttribute("satisfaction") Satisfaction satisfaction, 
		...
		if (bindingResult.hasErrors()) {
		    ...
		    return "redirect:/cop/stf/anonymous/selectBoardArticle.do";
		}
		...
		return "redirect:/cop/bbs/anonymous/selectArticleDetail.do";
    }
    ...
    public String deleteSatisfaction(@ModelAttribute("searchVO") SatisfactionVO satisfactionVO, @ModelAttribute("satisfaction") Satisfaction satisfaction, ModelMap model, RedirectAttributes redirect) throws Exception {
	...
	return "redirect:/cop/bbs/anonymous/selectBoardArticle.do";
    }
	...
	satisfactionVO.setProgrmNm(data.getProgrmNm());
