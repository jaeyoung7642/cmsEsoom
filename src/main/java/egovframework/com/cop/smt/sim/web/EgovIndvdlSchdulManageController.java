...
public class EgovIndvdlSchdulManageController {
    ...
    throws Exception {
    	...
    	return "cop/EgovIndvdlSchdulManageMainList";
    ...
    throws Exception {
		...
		****************************************************************** */
		...
		return "cop/EgovIndvdlSchdulManageDailyList";
	}
    ...
    throws Exception {
		...
		****************************************************************** */
		...
		return "cop/EgovIndvdlSchdulManageWeekList";
	}
...
//		int iDate = cal.get(java.util.Calendar.DATE);
		...
		return "cop/EgovIndvdlSchdulManageMonthList";
	}
    ...
    throws Exception {
		...
		String sLocationUrl = "cop/EgovIndvdlSchdulManageDetail";
    ...
    throws Exception {
		...
		String sLocationUrl = "cop/EgovIndvdlSchdulManageModify";
    ...
    throws Exception {
		...
		String sLocationUrl = "cop/EgovIndvdlSchdulManageRegist";
