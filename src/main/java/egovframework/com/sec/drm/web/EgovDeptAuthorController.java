...
public class EgovDeptAuthorController {
    ...
    public String selectDeptAuthorListView() throws Exception {
        return "manage/EgovDeptAuthorManage";
    }    
	 ...
	 * @exception Exception
	 */
    @IncludedInfo(name="부서권한관리", listUrl="/sec/drm/EgovDeptAuthorList.do", order = 330,gid = 20)
	...
	public String insertDeptAuthor(@RequestParam("userIds") String userIds,
        ...
        model.addAttribute("message", "");		
		return "redirect:/sec/drm/EgovDeptAuthorList.do";
	}
