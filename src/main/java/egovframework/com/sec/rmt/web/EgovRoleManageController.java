...
public class EgovRoleManageController {
	 ...
	 * @exception Exception
	 */
    @IncludedInfo(name="롤관리", listUrl="/sec/rmt/EgovRoleList.do", order = 300,gid = 20)
	...
	public String updateRole(@ModelAttribute("roleManage") RoleManage roleManage,
    	...
    	model.addAttribute("message", "");
    	//return "redirect:/sec/rmt/EgovRole.do";
    	return "redirect:/sec/rmt/EgovRoleList.do";
		}
	}
