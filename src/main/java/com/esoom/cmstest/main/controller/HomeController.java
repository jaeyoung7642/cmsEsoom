package com.esoom.cmstest.main.controller;
...
//		System.out.println("???????????????");
//		return "main/EgovUnitMain";
//	}
	@RequestMapping("/egovadmin/EgovContent.do")
	public String setContent(ModelMap model) {
		return "egovframework/com/cmm/EgovUnitContent";
	}
	@RequestMapping("/egovadmin/user.do")
	public String user() {
	...
	public String top() {
		return "main/EgovUnitTop";
	}

	@RequestMapping("/egovadmin/EgovBottom.do")
