...
<c:set var="pageTitle"><spring:message code="comUssIonMtg.mtgPlaceDetail.title"/></c:set>
<!DOCTYPE html>
...
var path = "<c:url value='/uss/ion/mtg/selectMtgPlaceManageList.do' />";
		...
		<tr>
			...
			<td class="left" colspan="3">
			     <c:import charEncoding="utf-8" url="/cmm/fms/selectFileInfs.do" >
					<c:param name="param_atchFileId" value="${egovc:encrypt(mtgPlaceManage.atchFileId)}" />
				</c:import>				
			</td>
		</tr>
		</c:if>	
