				...
				<div class="row">
					<div class="col-12">
						<div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
							<h4 class="mb-sm-0">조직관리 <spring:message code="title.create" /></h4>
				
							<div class="page-title-right">
								<ol class="breadcrumb m-0">
									<li class="breadcrumb-item"><a href="javascript: void(0);">관리자관리</a></li>
									<li class="breadcrumb-item active">조직관리 <spring:message code="title.create" /></li>
								</ol>
							</div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title mb-0 fw-semibold">조직 등록</h5>
							</div>
							<div class="card-body">

<form:form modelAttribute="deptManage" name="deptManage" method="post" action="${pageContext.request.contextPath}/uss/umt/dpt/addDeptManage.do' />" onSubmit="fncDeptManageInsert(); return false;" enctype="multipart/form-data">
	<div class="row">
		<!-- 입력 -->
		...
		<div class="col-md-6">
			<div class="mb-3">
				...
				<form:select path="orgnztTy" id="orgnztTy" cssClass="form-select">
		...
		<div class="col-md-6">
			<div class="mb-3">
				...
				<input type="text" class="form-control" id="orgnztNo" name="orgnztNo">
			</div>
		</div>
		<!--end col-->
		<div class="col-md-6">
				...
				<div class="row g-2 g-sm-3">
					<div class="col">
						<div class="form-check card-radio type2 line">
							<input class="form-check-input" type="radio" name="showAt" id="showAt1" value="Y" checked>
							<label class="form-check-label d-flex gap-2" for="showAt1">노출 <i class="ri-eye-line ms-auto icon-scale-1"></i></label>
						</div>
					</div>
					<div class="col">
						<div class="form-check card-radio type2 line">
							<input class="form-check-input" type="radio" name="showAt" id="showAt2" value="N">
		...
		<div class="col-md-12 mt-3">
			<div class="btn-toolbar gap-2 justify-content-end">
				<a href="<c:url value='/uss/umt/dpt/selectDeptManageListView.do'/>" class="btn btn-outline-primary w-sm fw-medium">목록</a>
				<input type="submit" class="btn btn-primary w-sm" value="<spring:message code="button.create" />" title="<spring:message code="button.create" /> <spring:message code="input.button" />" />
			</div>
		</div>
