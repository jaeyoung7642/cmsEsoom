...
<!-- content start -->
<form:form modelAttribute="userManageVO" action="${pageContext.request.contextPath}/AdminUpdt.do" name="userManageVO" method="post" onSubmit="fnUpdate(); return false;"> 
