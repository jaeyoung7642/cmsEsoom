...
<form:form modelAttribute="roleManage" method="post" action="${pageContext.request.contextPath}/sec/rmt/EgovRoleUpdate.do" onSubmit="fncRoleUpdate(); return false;"> 
	<div class="row align-items-center g-3 mb-3">
		...
		<!-- 하단 버튼 -->
		<div class="text-end">
			<span class="btn_s"><a href="<c:url value='/sec/rmt/EgovRoleList.do'/>" class="btn btn-success" title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
			<button class="btn btn-success" onClick="fncRoleDelete();return false;" title="<spring:message code="button.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></button>
			<input type="submit" class="btn btn-primary" value="<spring:message code="button.save" />" title="<spring:message code="button.save" /> <spring:message code="button.save" />" />
		</div>
