...
var path = "<c:url value='/sec/ram/EgovAuthorList.do'/>";
...
function fncAuthorUpdate() {
	var form = document.getElementById("authorManage");
...
<form:form modelAttribute="authorManage" action="${pageContext.request.contextPath}/sec/ram/EgovAuthorUpdate.do" method="post" onSubmit="fncAuthorUpdate(); return false;"> 
	<div class="row align-items-center g-3 mb-3">
		<div class="col-xxl-12">
			<div class="row">
				...
				<label for="authorCode" class="col-sm-2 col-form-label">${title} <span class="pilsu">*</span></label>
				<div class="col-sm-10">
		...
		<!-- 하단 버튼 -->
		<div class="text-end">
			<input type="submit" class="btn btn-primary" value="<spring:message code="button.update" />" title="<spring:message code="button.update" /> <spring:message code="input.button" />" /><!-- 수정 -->
			<span class="btn_s"><a href="<c:url value='/sec/ram/EgovAuthorList.do' />" class="btn btn-success" title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span><!-- 목록 -->
		</div>
