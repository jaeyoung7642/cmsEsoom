...
<form:form modelAttribute="groupManage" method="post" action="${pageContext.request.contextPath}/sec/gmt/EgovGroupInsert.do" onSubmit="fncGroupInsert(); return false;" enctype="multipart/form-data">
	...
	<div class="row align-items-center g-3 mb-3">
		<div class="col-xxl-12">
			<div class="row">
				...
				<div class="col-sm-10">
					<form:input path="groupNm" class="form-control" title="${title} ${inputTxt}" size="40" maxlength="50" />
