				...
				<div class="row">
					<div class="col-12">
						<div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
							<h4 class="mb-sm-0"><spring:message code="comUatUap.loginPolicyUpdt.pageTop.title"/></h4>
				
							<div class="page-title-right">
								<ol class="breadcrumb m-0">
									<li class="breadcrumb-item"><a href="javascript: void(0);">회원관리</a></li>
									<li class="breadcrumb-item active"><spring:message code="comUatUap.loginPolicyUpdt.pageTop.title"/></li>
								</ol>
							</div>
	...
	<div class="row align-items-center g-3 mb-3">
		...
		<div class="col-xxl-12">
			<div class="row">
				...
				<div class="col-sm-10">
					<input id="ipInfo" type="text" name="ipInfo" class="form-control" value="<c:out value='${loginPolicy.ipInfo}'/>" title="<spring:message code="comUatUap.loginPolicyRegist.ipInfo"/>" size="30" maxLength="23" />
		...
		<!-- 하단 버튼 -->
		<div class="text-end">
			<input class="btn btn-primary" type="submit" value='<spring:message code="button.save" />' onclick="fncLoginPolicyUpdate();return false;" /><!-- 저장 -->
			<a href="<c:url value='/uat/uap/removeLoginPolicy.do'/>?emplyrId=<c:out value='${loginPolicyVO.emplyrId}'/>" class="btn btn-success" onclick="fncLoginPolicyDelete(); return false;"><spring:message code="button.delete" /></a><!-- 삭제 -->
			<a href="<c:url value='/uat/uap/selectLoginPolicyList.do'/>?pageIndex=<c:out value='${loginPolicyVO.pageIndex}'/>&amp;searchKeyword=<c:out value="${loginPolicyVO.searchKeyword}"/>&amp;searchCondition=1" onclick="fncSelectLoginPolicyList(); return false;" class="btn btn-success"><spring:message code="button.list" /></a><!-- 목록 -->
		</div>
	</div>
