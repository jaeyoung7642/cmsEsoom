			...
			<div class="col list-element">            
				<div class="card explore-box card-animate">                
					<div class="explore-place-bid-img">                    
						...
						<img src="${pageContext.request.contextPath}/cmm/fms/imageView.do?atchFileId=<c:out value="${resultInfo.thumFileId}"/>&fileSn=0"  class="card-img-top explore-img" />                 
					...
					<div class="card-body">                    
						<p class="fw-medium mb-0 float-end"><i class="mdi mdi-eye text-danger align-middle"></i> <c:out value='${resultInfo.inqireCo}'/> </p>                    
						<h5 class="mb-1">
						...
						<p class="text-muted mb-0"><c:out value='${resultInfo.frstRegisterPnttm}'/></p>                
					</div>                
				</div>        
			</div>
			</c:forEach>
