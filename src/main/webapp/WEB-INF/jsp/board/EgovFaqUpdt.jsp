...
<!-- 상단타이틀 -->
<form:form modelAttribute="faqVO" action="${pageContext.request.contextPath}/uss/olh/faq/updateFaq.do" method="post" onSubmit="fn_egov_updt_faq(document.getElementById('faqVO')); return false;" enctype="multipart/form-data">
