...
<form name="newsForm" action="<c:url value='/uss/ion/nws/updateNewsView.do'/>" method="post">
	...
	<div class="table-responsive table-card">
		...
		<table class="table mb-0" summary="<spring:message code="common.summary.inqire" arguments="${pageTitle}" />">
			...
			<tbody>
				...
				<tr>
					<th>뉴스URL</th>
					<td class="left"><c:out value="${result.newsUrl}"/></td>
				</tr>
	...
	<div class="text-end mt-4 pt-2 gap-2">
		...
		<a href="<c:url value='/uss/ion/nws/deleteNews.do' />" class="btn btn-success" onClick="fn_egov_delete_news('<c:out value="${result.newsId}"/>'); return false;"  title="<spring:message code="button.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></a>
		<a href="<c:url value='/uss/ion/nws/selectNewsList.do' />" class="btn btn-success" title="<spring:message code="title.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a>
	</div>
