<%
 /**
  * @Class Name : EgovQnaList.jsp
  * @Description : EgovQnaList 화면
										...
										<div class="col-xl-auto">
											<div class="d-flex flex-column flex-md-row gap-2">
												...
												<div class="d-flex gap-2 flex-grow-1">
													...
													<a href="<c:url value='/uss/olh/qna/insertQnaView.do' />"  title="" class="btn btn-primary">
			...
			<table class="table align-middle table-nowrap mb-0" id="qnaListTable">
				...
				<tbody class="ov">
					...
					<tr>
						...
						<td>
							<form name="sub${resultInfo.qaId}Form" method="post" action="<c:url value='/uss/olh/qna/selectQnaDetail.do'/>">
							    <input name="qaId" type="hidden" value="<c:out value="${resultInfo.qaId}"/>">
							    <input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>"/>
							    <a href="#" onclick="sub${resultInfo.qaId}Form.submit();return false;"><c:out value='${fn:substring(resultInfo.qestnSj, 0, 40)}'/></a>
							</form>
						</td>
