...
<!-- 상단타이틀 -->
<form:form modelAttribute="articleScrapVO" action="${pageContext.request.contextPath}/cop/scp/updateArticleScrap.do" method="post"	onSubmit="fn_egov_updt_articleScrap(document.forms[0]); return false;">
