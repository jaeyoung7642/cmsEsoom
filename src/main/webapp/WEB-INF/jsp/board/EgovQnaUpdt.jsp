...
function fn_egov_inqire_list() {
	qnaVO.action = "<c:url value='/uss/olh/qna/selectQnaList.do'/>";
	qnaVO.submit();	
}
</script>
</head>
...
<!-- 상단타이틀 -->
<form:form modelAttribute="qnaVO" action="${pageContext.request.contextPath}/uss/olh/qna/updateQna.do" method="post" onSubmit="fn_egov_updt_qna(document.forms[0]); return false;">  
	...
	<div class="row align-items-center g-3 mb-3">
		<div class="col-xxl-12">
			<div class="row">
				...
				<div class="col-sm-10">
					<form:input path="wrterNm" title="${title} ${inputTxt}" class="form-control" maxlength="70" readonly="true" />
		...
		<div class="col-xxl-12">
			<div class="row">
				...
				<div class="col-sm-10">
				    <form:input path="areaNo" title="${title} ${inputTxt}" class="form-control" size="70" maxlength="70" style="width:72px;display:inline-block;"/>&nbsp;-&nbsp;
				    <form:input path="middleTelno" title="${title} ${inputTxt}" class="form-control" size="70" maxlength="70" style="width:72px;display:inline-block;"/>&nbsp;-&nbsp;
				    <form:input path="endTelno" title="${title} ${inputTxt}" class="form-control" size="70" maxlength="70" style="width:72px;display:inline-block;"/>
		...
		<div class="col-xxl-6">
			<div class="row">
				...
				<div class="col-sm-8">
				    <form:input path="emailAdres" class="form-control" title="${title} ${inputTxt}" size="70" maxlength="70" />
		...
		<div class="col-xxl-6">
			<div class="row">
				...
				<div class="col-sm-8 col-form-label">
					<form:checkbox path="emailAnswerAt" value="Y" class="form-check-input"/>
		...
		<div class="col-xxl-12">
			<div class="row">
				...
				<div class="col-sm-10">
				    <form:input path="qestnSj" class="form-control" title="${title} ${inputTxt}" size="70" maxlength="70" />
		...
		<div class="col-xxl-12">
			<div class="row">
				...
				<div class="col-sm-10">
					<form:textarea path="qestnCn" class="form-control" title="${title} ${inputTxt}" cols="300" rows="10" />   
		...
		<div class="text-end">
			...
			<a href="<c:url value='/uss/olh/qna/selectQnaList.do' />" class="btn btn-success"><spring:message code="button.list"/></a>
		</div>
	</div>
