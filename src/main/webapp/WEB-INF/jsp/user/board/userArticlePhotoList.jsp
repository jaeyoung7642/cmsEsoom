			...
			<div class="ly_inner sub_content_wrap">
				...
				<section id="content" class="ly_content">
					...
					<article class="board_list">
						...
						<div class="board_header">
							...
							<div class="search_box">
								<form name="articleForm" action="<c:url value='/user/selectArticleList.do'/>" method="post" onSubmit="fn_egov_search_article(); return false;" class="search_box_form frm_group">
									...
									<input name="bbsId" id="bbsId" type="hidden" value="${boardMasterVO.bbsId}">
						...
						<!-- board list -->
						<ul class="bbs_list_card">
						<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
							<li class="item">
								<a href="<c:url value='/user/selectArticleDetail.do?bbsId=${resultInfo.bbsId}&nttId=${resultInfo.nttId}'/>" class="bbs_link bl_box sdw">
									<div class="el_thumb">
										<img src="/esoomCms/cmm/fms/imageView.do?atchFileId=<c:out value="${resultInfo.thumFileId}"/>&fileSn=0" alt="" width="340" height="250">
										<div class="mask end"><!--<span class="total">12</span>--></div>
									</div>
									<div class="bbs_cont">
										<p class="tit txt_line2 txt_20-18">${resultInfo.nttSj }</p>
										<div class="bbs_info">
