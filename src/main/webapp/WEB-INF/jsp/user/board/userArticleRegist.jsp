...
<body class="page-sub" onLoad="fn_egov_init();"> <!-- 서브에서 page-sub 클래스 추가 -->
	<div id="wrap">
		<!-- skip navigation -->
			...
			<div class="ly_inner sub_content_wrap">
				...
				<section id="content" class="ly_content">
					...
					<article class="board_write">
						<form:form modelAttribute="articleVO" action="${pageContext.request.contextPath}/user/insertArticle.do" method="post" onSubmit="return fn_egov_regist_article(document.forms[0]);" enctype="multipart/form-data">
