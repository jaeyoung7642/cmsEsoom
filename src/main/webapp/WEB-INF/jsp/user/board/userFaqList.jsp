...
function fn_egov_select_linkPage(pageNo){
	...
	document.faqForm.action = "<c:url value='/user/selectFaqList.do'/>";
					...
					<article class="board_list">
						...
						<div class="board_header">
							...
							<div class="search_box">
								<form name="faqForm" action="<c:url value='/user/selectFaqList.do'/>" method="post" onSubmit="fn_egov_search_faq(); return false;" class="search_box_form frm_group">
						...
						<!-- faq list -->
						<div class="bbs_list_faq accordion" role="table" aria-labelledby="faq-header">
							<div class="row faq_header" id="faq-header" role="row">
								<div class="col w80" role="columnheader" id="col-num">번호</div>
								<div class="col cont" role="columnheader" id="col-cont">질문</div>
								<div class="col w120 m_hide" role="columnheader" id="col-date">작성일</div>
							</div>
							<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
							<!-- row -->
							<dl class="row faq_content accordion_item" role="row">
								<dt>
									<div class="col w80" role="cell" aria-labelledby="col-num"><c:out value="${(searchVO.pageIndex-1) * searchVO.pageUnit + status.count}"/></div>
									<div class="col cont" role="cell" aria-labelledby="col-cont">
										<button type="button" class="accordion_btn" role="cell" aria-labelledby="col-cont" aria-expanded="false" aria-label="답변 열기">
											${resultInfo.qestnSj}
										</button>
									</div>
									<div class="col w120 m_hide" role="cell" aria-labelledby="col-date"><c:out value='${resultInfo.frstRegisterPnttm}'/></div>
								</dt>
								<dd class="accordion_content" role="row">
									<div class="inner">
										<span class="col w80" role="cell"><span class="el_ico answer"></span></span>
										<span class="col cont txt_preline" role="cell"><c:out value='${resultInfo.qestnCn}'/></span>
									</div>
								</dd>
							</dl>
							<!-- //row -->
