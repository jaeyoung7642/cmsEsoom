		...
		<main id="container" class="ly_container">
			...
			<div class="ly_inner sub_content_wrap">
				...
				<section id="content" class="ly_content">
					...
					<!-- page tabs -->
					<nav class="page_tabs type1">
						<ul class="tab_list">
							<li class="tab_li"><a href="#" class="tab_link current">사진</a></li>
							<li class="tab_li"><a href="#" class="tab_link">영상</a></li>
						</ul>
					</nav>
					<!-- 게시판 상세페이지 -->
					<article class="board_view">
						...
						<!-- view detail -->
						<div class="board_view_detail gallery_slider">
							<!-- bigimg -->
							...
							<div class="gallery_bigimg">
								...
								<div class="swiper-button-prev el_btn btn1 type2"><c-icon name="arrLeft4"></c-icon><span class="blind">이전보기</span></div>
								<div class="swiper-button-next el_btn btn1 type2"><c-icon name="arrRight4"></c-icon><span class="blind">다음보기</span></div>
							</div>
							</c:if>
							<!-- //bigimg -->
									...
									<div class="swiper-wrapper">
										...
										<div class="swiper-slide el_thumb" style="background-image: url('/cmsTest/cmm/fms/imageView.do?atchFileId=<c:out value="${fileList.atchFileId}"/>&fileSn=${status.index}');">
											...
											<label class="frm_checkbox type1">
												<input type="checkbox" aria-label="${status.index}번 이미지 선택">
											</label>
										</div>
										</c:forEach>
									</div>
								</div> 		
								<div class="swiper-button-prev el_btn btn1 type3"><c-icon name="arrLeft2"></c-icon><span class="blind">이전보기</span></div>
								<div class="swiper-button-next el_btn btn1 type3"><c-icon name="arrRight2"></c-icon><span class="blind">다음보기</span></div>
							</div>
							<!-- //thumbnail -->
					...
					<!-- //게시판 상세페이지 -->
					<div class="btn_area mt30 p_end gap10">
						<!--<a href="#" class="el_btn btn2 light w140">사진 다운로드</a>-->
