			...
			<div class="ly_inner sub_content_wrap">
				...
				<section id="content" class="ly_content">
					...
					<nav class="page_tabs type1">
						<ul class="tab_list">
							<li class="tab_li"><a href="#" class="tab_link current">본청</a></li>
							<li class="tab_li"><a href="#" class="tab_link">구청</a></li>
							<li class="tab_li"><a href="#" class="tab_link">직속기관/사업소</a></li>
							<li class="tab_li"><a href="#" class="tab_link">동남구 읍면동</a></li>
						</ul>
					</nav>
					<!-- 게시판 상세페이지 -->
