					...
					<article class="board_list">
						...
						<table class="bbs_list_tbl">
							...
							<c:forEach items="${noticeList}" var="noticeList" varStatus="status">
								<tr>
									<td class="num"><span class="el_badge point">공지</span></td>
									<td class="tit">
										
										<a href="<c:url value='/user/selectArticleDetail.do?bbsId=${noticeList.bbsId}&nttId=${noticeList.nttId}'/>" class="tit_link">
											<span class="tit_txt txt_line1-2">
												<span class="el_badge point m_show">공지</span> <!-- 공지시 추가 -->
												${noticeList.nttSj }
											</span>
										</a>
									</td>
									<!--<td class="name info"><c:out value='${noticeList.frstRegisterNm}'/></td>-->
									<td class="date info"><c:out value='${noticeList.frstRegisterPnttm}'/></td>
									<!--<td class="file info">
										<div class="el_fills">
											<span class="file han"></span>
											<span class="file pdf"></span>
											<span class="file img"></span>
										</div>
									</td>-->
									<td class="num"><c:out value='${noticeList.inqireCo}'/></td>
								</tr>
							</c:forEach>	
