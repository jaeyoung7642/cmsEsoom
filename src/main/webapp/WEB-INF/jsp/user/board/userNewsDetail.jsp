				...
				<section id="content" class="ly_content">
					...
					<article class="board_view">
						...
						<div class="board_view_header">
							<div class="tit_area">
								<h4 class="subject">${result.newsSj}</h4>
							</div>
						...
						<div class="board_view_detail">
							<!-- 💡 줄바꿈 없이 콘텐츠 넣기 -->
							<div class="content txt_preline txt_16-14">${result.newsCn}</div>  
						</div>
						<!-- //view detail -->
						<!-- view file -->
					...
					<div class="btn_area mt30 p_end">
						<a href="<c:url value='/user/selectNewsList.do' />" class="el_btn btn2 point w140">목록</a>
					</div>
					<!-- 만족도 조사 -->
