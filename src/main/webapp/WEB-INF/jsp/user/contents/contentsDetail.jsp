				...
				<section id="content" class="ly_content">
					...
					<section class="page_contents">
						...
						<div class="board_view_detail">
							<!-- 💡 줄바꿈 없이 콘텐츠 넣기 -->
							<div class="content txt_preline txt_16-14"><c:out value="${fn:replace(result.conCont , crlf , '<br/>')}" escapeXml="false" /></div>  
						</div>
						<!-- //view detail -->
					</section>
					<!-- //contents -->
							...
							<div class="col">
								...
								<form class="frm_field research_forms">
									...
									<div class="frm_group m_col">
										...
										<button type="button" class="el_btn btn2 blue w150" onclick="insertSatisfaction('${result.conCode}','content')">의견 남기기</button>
									</div>
								</form>
							</div>
						</div>
