...
function fn_validatorMenuList() {
	console.log(document.menuManageVO.menuNo);
				...
				<div class="row">
					<div class="col-12">
						<div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
							<h4 class="mb-sm-0"><spring:message code="comSymMnuMpm.menuRegist.pageTop.title"/></h4>
				
							<div class="page-title-right">
								<ol class="breadcrumb m-0">
									<li class="breadcrumb-item"><a href="javascript: void(0);">메뉴관리</a></li>
									<li class="breadcrumb-item active"><spring:message code="comSymMnuMpm.menuRegist.pageTop.title"/></li>
								</ol>
							</div>
						...
						<div class="card">
							<div class="card-body">
								...
								<form:form modelAttribute="menuManageVO" name="menuManageVO" method="post" action="${pageContext.request.contextPath}/sym/mnu/mpm/EgovMenuRegistInsert.do">
                                    ...
                                    <div class="row align-items-center g-3 mb-3">
                                        <div class="col-xxl-6">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
												    <form:input path="menuNo" maxlength="10" title="" class="form-control" id="menuNo" /><!-- 메뉴No -->
                                        ...
                                        <div class="col-xxl-6">
                                            <div class="row">
                                                <label for="menuUrl" class="col-sm-4 col-form-label"><spring:message code="comSymMnuMpm.menuList.progrmFileNm"/> <span class="pilsu">*</span></label><!-- 메뉴URL -->
                                                <div class="col-sm-8">
                                        ...
                                        <div class="col-xxl-6">
                                            <div class="row">
                                                <label for="menuTab" class="col-sm-4 col-form-label">탭메뉴설정<span class="pilsu">*</span></label><!-- 메뉴URL -->
                                                <div class="col-sm-8">
												    <div class="form-check form-check-inline">
														<input class="form-check-input" id ="menuTab1" type="radio" name="menuTab" value="N"/>
													    <label class="form-check-label" for="menuTab1">일반</label>
													</div>
													<div class="form-check form-check-inline">
														<input class="form-check-input" id ="menuTab2" type="radio" name="menuTab" value="Y" />
                                        ...
                                        <div class="col-xxl-6">
                                            <div class="row">
                                                <label for="menuTarget" class="col-sm-4 col-form-label">새창여부<span class="pilsu">*</span></label><!-- 메뉴URL -->
                                                <div class="col-sm-8">
												    <div class="form-check form-check-inline">
													<input class="form-check-input" id ="menuTarget1" type="radio" name="menuTarget" value="N"/>
												    <label class="form-check-label" for="menuTarget1">N</label>
												</div>
												<div class="form-check form-check-inline">
													<input class="form-check-input" id ="menuTarget2" type="radio" name="menuTarget" value="Y" />
									...
									<div class="text-end">
										<button type="submit" class="btn btn-primary" onclick="insertMenuManage(document.forms[0]); return false;">등록</button>
