  	...
  	<div class="row align-items-center g-3 mb-3">
		<div class="col-xxl-12">
			<div class="row">
				...
				<div class="col-sm-10">
					<input name="qestnrCn" id="qestnrCn" title="<spring:message code='comUssOlpQqm.regist.qestnrCn'/><spring:message code='input.input'/>" type="text" size="73" value="${qestnrInfo.qestnrSj}" maxlength="2000" class="form-control" style="width:300px; display:inline-block;" disabled="disabled"><!-- title="설문지정보(제목) 입력" -->
		...
		<div class="col-xxl-12">
			<div class="row">
				...
				<div class="col-sm-10">
					<input name="qestnSn" id="qestnSn" type="text" size="50" value="1" maxlength="10" class="form-control" style="width:100px;" title="<spring:message code='comUssOlpQqm.regist.qestnSn'/><spring:message code='input.input'/>"><!-- title="질문순번 입력" -->
		...
		<div class="col-xxl-12">
			<div class="row">
				...
				<div class="col-sm-10">
					<textarea name="qestnCn" id="qestnCn" class="form-control"  cols="75" rows="10"  style="width:99%;" title="<spring:message code='comUssOlpQqm.regist.qestnCn'/><spring:message code='input.input'/>"></textarea><!-- title="질문내용 입력" -->
