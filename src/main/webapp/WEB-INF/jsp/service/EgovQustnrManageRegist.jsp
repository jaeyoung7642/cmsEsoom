			...
			<div class="row">
				...
				<div class="col-sm-10">
					<table style="border:0px; cellspacing:0px; cellpadding:0px; align:center;" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<c:forEach items="${listQustnrTmplat}" var="resultQustnrTmplat" varStatus="status">
							<td height="10" align="center"><input type="radio" name="qestnrTmplatId" value="${resultQustnrTmplat.qestnrTmplatId}" class="form-check-input" checked> ${resultQustnrTmplat.qestnrTmplatTy}</td>
							</c:forEach>
						</tr>
					</table>
				</div>
