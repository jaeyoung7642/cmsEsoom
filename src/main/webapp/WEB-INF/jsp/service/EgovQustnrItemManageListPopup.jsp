							...
							<tbody class="ov">	
								...
								<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
								  <tr>
									...
									<!-- 선택 -->
									<td class="lt_text3">
										<a href="#LINK" class="btn btn-sm btn-success" onClick="fn_egov_open_QustnrItemManage('${resultInfo.qestnrId}', '${resultInfo.qestnrTmplatId}', '${resultInfo.qustnrIemId}', '${status.count}')"><spring:message code="input.cSelect" /></a><!-- 선택 -->
