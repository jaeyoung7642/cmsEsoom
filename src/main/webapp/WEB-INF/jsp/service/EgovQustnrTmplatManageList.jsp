										...
										<form name="listForm" action="<c:url value='/uss/olp/qtm/EgovQustnrTmplatManageList.do'/>" method="post" onSubmit="fn_egov_search_QustnrTmplatManage(); return false;">
											<div class="d-flex flex-column flex-md-row gap-2">
												...
												<div class="d-flex gap-2 flex-grow-1">
													...
													<a href="<c:url value='/uss/olp/qtm/EgovQustnrTmplatManageRegist.do' />" class="btn btn-primary w-xs"><i class="ri-add-line align-bottom me-1"></i> 등록</a>
												</div>
											</div>
						...
						<td class="lt_text3L">
							<div class="d-flex align-items-center">
								<div class="flex-shrink-0 me-3">
									<div class="avatar-sm avatar-fit rounded"><img src="<c:url value='/uss/olp/qtm/EgovQustnrTmplatManageImg.do'/>?qestnrTmplatId=${resultInfo.qestnrTmplatId}" alt=""></div>
								</div>
								<div class="flex-grow-1">
									<a href="<c:url value='/uss/olp/qtm/EgovQustnrTmplatManageDetail.do'/>?qestnrTmplatId=${resultInfo.qestnrTmplatId}" class="fw-medium link-primary" onClick="fn_egov_detail_QustnrTmplatManage('<c:out value="${resultInfo.qestnrTmplatId}"/>');return false;">
										${resultInfo.qestnrTmplatTy}
									</a>
								</div>
							</div>
						</td>
