...
<form:form modelAttribute="popupManageVO" name="popupManageVO" action="${pageContext.request.contextPath}/uss/ion/pwm/updtPopup.do" method="post" >
	...
	<div class="row align-items-center g-3 mb-3">
		...
		<div class="col-xxl-12">
			<div class="row">
				<label for="ntceBgndeYYYMMDD" class="col-sm-2 col-form-label"><spring:message code="ussIonPwm.popupRegist.ntcePeriod"/> <span class="pilsu">*</span></label>
				<div class="col-sm-10">
					<input id="ntceBgndeYYYMMDD" type="text" name="ntceBgndeYYYMMDD" type="text" class="form-control flatpickr-input active" data-provider="flatpickr" data-date-format="Y-m-d" value="<c:out value="${fn:substring(popupManageVO.ntceBgnde, 0, 4)}"/>-<c:out value="${fn:substring(popupManageVO.ntceBgnde, 4, 6)}"/>-<c:out value="${fn:substring(popupManageVO.ntceBgnde, 6, 8)}"/>" readonly="readonly" style="width:120px;display:inline-block;">
					...
					&nbsp;~&nbsp;
					<input id="ntceEnddeYYYMMDD" type="text" name="ntceEnddeYYYMMDD" type="text" class="form-control flatpickr-input active" data-provider="flatpickr" data-date-format="Y-m-d" value="<c:out value="${fn:substring(popupManageVO.ntceEndde, 0, 4)}"/>-<c:out value="${fn:substring(popupManageVO.ntceEndde, 4, 6)}"/>-<c:out value="${fn:substring(popupManageVO.ntceEndde, 6, 8)}"/>" readonly="readonly" style="width:120px;display:inline-block;">
			...
			<div class="row">
				...
				<div class="col-sm-10">
					<div class="form-check form-check-inline">
					    <input class="form-check-input" type="radio" id="stopVewAt1" name="stopVewAt" value="Y" <c:if test="${popupManageVO.stopVewAt eq 'Y'}">checked</c:if>>
					    <label class="form-check-label" for="stopVewAt1">Y</label>
					</div>
					<div class="form-check form-check-inline">
					    <input class="form-check-input" type="radio" id="stopVewAt2" name="stopVewAt" value="N" <c:if test="${popupManageVO.stopVewAt eq 'N'}">checked</c:if>>
		...
		<div class="col-xxl-12">
			<div class="row">
				...
				<div class="col-sm-10">
					<div class="form-check form-check-inline">
					    <input class="form-check-input" type="radio" id="ntceAt1" name="ntceAt" value="Y" <c:if test="${popupManageVO.ntceAt eq 'Y'}">checked</c:if>>
					    <label class="form-check-label" for="ntceAt1">Y</label>
					</div>
					<div class="form-check form-check-inline">
					    <input class="form-check-input" type="radio" id="ntceAt2" name="ntceAt" value="N" <c:if test="${popupManageVO.ntceAt eq 'N'}">checked</c:if>>
