...
<c:set var="pageTitle"><spring:message code="comSymBat.batchOpertRegist.title"/></c:set>
<!DOCTYPE html>
...
<form:form modelAttribute="batchOpert"  action="<c:url value='/sym/bat/addBatchOpert.do'/>" method="post">
