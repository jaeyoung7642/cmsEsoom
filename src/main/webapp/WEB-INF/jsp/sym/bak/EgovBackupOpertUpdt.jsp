...
<c:set var="pageTitle"><spring:message code="comSymSymBak.backupOpertUpdt.title"/></c:set>
<!DOCTYPE html>
...
<form:form modelAttribute="backupOpert"  action="<c:url value='/sym/sym/bak/updateBackupOpert.do' />" method="post">
...
<noscript class="noScriptTitle"><spring:message code="common.noScriptTitle.msg" /></noscript><!-- 자바스크립트를 지원하지 않는 브라우저에서는 일부 기능을 사용하실 수 없습니다. -->
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
			    <form:input path="backupOpertId" maxlength="20" readonly="true" cssClass="readOnlyClass" cssStyle="width:138px"/>
