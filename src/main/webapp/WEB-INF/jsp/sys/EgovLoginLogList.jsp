		...
		<div class="table-responsive table-card mb-4">
			<table class="table align-middle table-nowrap mb-0">
				...
				<tr>
					...
					<td>
						<button type="button" class="btn btn-soft-secondary btn-sm"  onclick="fn_egov_detail_loginLog('<c:out value="${result.logId}"/>'); return false;"><i class="   ri-search-line align-bottom"></i></button>
					</td>
				</tr>
				</c:forEach>
				</tbody>
